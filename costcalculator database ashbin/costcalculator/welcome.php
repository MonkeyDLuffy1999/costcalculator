...
<body class="jumbotron">
  ...
  <form action="data.php" method = "POST">
        ...
        <br>
        <select class="form-select" name ="List" id= "list" required>
        <option value ="0" selected>Please select: </option>
        <option value="General Manufacturing">General Manufacturing</option>
        <option value="Agriculture and Livestock">Agriculture and Livestock</option>
        <option value="Services - Food and Beverages">Services - Food and Beverages</option>
        <option value="Services - Utilities">Services - Utilities</option>
        <option value="Services - Banking and finance">Services - Banking and finance</option>
        <option value="Construction and associated trades">Construction and associated trades</option>
        <option value="Public Transportation">Public Transportation</option>
        <option value="Transport - interstate and heavy haulage">Transport - interstate and heavy haulage</option>
        <option value="Transport - interstate haulage and distribution">Transport - interstate haulage and distribution</option>
        <option value="Transport - light haulage and freight">Transport - light haulage and freight</option>
        <option value="Transport - postal services">Transport - postal services</option>
        <option value="Transport - mixed freight">Transport - mixed freight</option>
        <option value="Transport - other transport">Transport - other transport</option>
        <option value="Other manufacturing">Other manufacturing</option>
        <option value="Other">Other</option>
        </select>
<br>
        <label class="form-label">Your main revenue earner: </label>
        <input class="form-control" type="number" name = "Insert" id="insert" placeholder="Enter revenue earner" required/>
    
  
  <br>
  <p>
        <input class="next-button btn btn-outline-success btn-md" type = "submit" value = "Submit" />
  </p>
</div>
</form>
          <hr>
