...
if (mysqli_connect_error()){
    ...
    $Insert = trim($_POST["Insert"]); 
       ...
       $query = "insert into $sql_table (sector, revenue)
    values ('$List', '$Insert')";
...
<!--
            <div id='gform_page_19_2' class='gform_page' style='display:none;'> -->
              ...
              <div class="data-entry">
                <label class="form-label">Annual unit sales of ?</label>
                <input class="form-control" type="number" name = "Sales" id="sales" placeholder="Value in dollar($)"required>
                <label class="form-label" class="form-label">Annual claims data - cost of incident (insurer's costs)</label>
                <input class="form-control" type="number" name = "Insurer" id="insurer" placeholder="Value in dollar($)"required>
                <label class="form-label">Annual claims data - number of incidents</label>
                <input class="form-control" type="number" name = "Incident" id="incident" placeholder=""required>
                <label class="form-label">Total Number of Vehicles</label>
                <input class="form-control" type="number" name = "Vehicles" id="vehicles"placeholder=""required>
                <label class="form-label">Annual total distance travelled by fleet (kms)</label>
                <input class="form-control" type="number" name = "Distance" id="distance" placeholder=""required>
                <label class="form-label">Annual Fleet Insurance Premium</label>
                <input class="form-control" type="number" name = "Insurance" id="insurance" placeholder="Value in dollar($)"required>
                
                <label class="form-label"class="form-label">Excess per claim</label>
                <input class="form-control" type="number" name = "Excess" id="excess" placeholder="Value in dollar($)"required>
                <label class="form-label">Return on</label>
                <input class="form-control" type="number" name = "Return" id="return" placeholder="Return percentage(%)"required>
                <label class="form-label">Gross annual turnover</label>
                <input class="form-control" type="number" name = "Turnover" id="turnover" placeholder="Value in dollar($)"required>
                
                <label class="form-label">Average unit costs of</label>
                <input class="form-control" type="number" name = "Unitcost" id="unitcost" placeholder="Value in dollar($)"required>
                <label class="form-label">Grey Fleet</label>
                <input class="form-control" type="number" name = "Grey" id="grey" placeholder=""required>
                <label class="form-label">Estimated average annual business fleet travel (kms) of employees using their own vehicle (if you are liable for grey fleet)</label>
                <input class="form-control" type="number" name = "Liable" id="liable" placeholder=""required>
                <hr>

              </form>
              <p>
        <input input class="next-button btn btn-outline-success btn-md" type = "submit" value = "Submit" />
        </p>
